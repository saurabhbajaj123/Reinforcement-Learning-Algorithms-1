...
def main():
    ...
    #         avg_count += td.td(running_average_length=10)
    ...
    for _ in tqdm(range(runs)):
        td = TD(alpha=alpha, gamma=gamma, delta=delta)
        count =  td.td(running_average_length=10)
    ...
    print(round(np.amax(avg_value_function - td.v_star), 4))
